                ...
                <tbody id="privilegesTableBody">
                    ...
                    @foreach ($modules as $index => $module)
                        <tr data-row="{{ $index }}">
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $module['name'] }}</td>
                            <td><input type="checkbox" class="all-checkbox" data-row="{{ $index }}"
                                    data-module="{{ $module }}" data-action="all"></td>
                            <td><input type="checkbox" class="row-checkbox permission-checkbox"
                                    data-row="{{ $index }}" data-module="{{ $module }}" data-action="create"
                                    {{ in_array($module['slug'] . '.create', $roleHasPermissions) ? 'checked' : '' }}></td>
                            <td><input type="checkbox" class="row-checkbox permission-checkbox"
                                    data-row="{{ $index }}" data-module="{{ $module }}" data-action="view"
                                    {{ in_array($module['slug'] . '.view', $roleHasPermissions) ? 'checked' : '' }}></td>
                            <td><input type="checkbox" class="row-checkbox permission-checkbox"
                                    data-row="{{ $index }}" data-module="{{ $module }}" data-action="edit"
                                    {{ in_array($module['slug'] . '.edit', $roleHasPermissions) ? 'checked' : '' }}></td>
                            <td><input type="checkbox" class="row-checkbox permission-checkbox"
                                    data-row="{{ $index }}" data-module="{{ $module }}" data-action="delete"
                                    {{ in_array($module['slug'] . '.delete', $roleHasPermissions) ? 'checked' : '' }}></td>
